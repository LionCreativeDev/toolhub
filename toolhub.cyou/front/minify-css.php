            ...
            <div class="row">
                ...
                <div class="col-md-9 col-xl-9">
                    <main>
                        ...
                        <h2 class="u-h3 u-mb-small">Minify CSS</h2>
								...
								<form class="c-search-form c-search-form--dark">
									...
									<div class="c-search-form__section">
										<div class="c-field has-icon-left">
											...
											<textarea class="c-input" id="txtCss"></textarea>
							...
							<div class="col-sm-12 col-lg-12 col-xl-12">
								<div class="c-search-form c-search-form--dark">
									...
									<div class="c-search-form__section">
										<div class="c-field has-icon-left">
											<!--<span class="c-field__icon"><i class="fa fa-user-o"></i></span>-->
											<label class="c-field__label c-search-form__label" for="search-position">Minified CSS</label>
											<textarea class="c-input" id="txtMinifiedCss"></textarea>
		...
		<script>
			...
			$('button[type=submit]').click(function(e){
				...
				if(BlobBuilder) {
					...
					var aFileParts = [''+$('#txtCss').val()+''];
					oBuilder.append(aFileParts[0]);
					blob = oBuilder.getBlob("text\/plain"); // the blob
					
				} else {
					// everyone else
					blob = new Blob([''+$('#txtCss').val()+''], { 'type': 'text/plain' });    
				}
				
				var data = new FormData();
				data.append('csssource', blob);
				...
				$.ajax({
					...
					contentType: false,
					processData: false,
					url: "https://api.toolhub.cyou/WebsiteTools.php?action=minifycss&query=infile",
					success: function(serverresponse){
						...
						if(response["success"] === 'true')
						{
							...
							$('#txtMinifiedCss').val(decodeURIComponent((response['result']['minified']).replace(/%(?![\da-f]{2})/gi,'%25')));
							$('.result').show();
						}
			...
			// $('button[type=submit]').click(function(e){
				...
				// // $.ajax({
					// // //beforeSend: function() { textreplace(description); },
					// // type: "GET",  
					// // url: "http://localhost:8080/seotoolstationclone/WebsiteTools.php?action=minifycss&query="+encodeURIComponent($('#txtCss').val()),
					...
					// // success: function(serverresponse){
						...
						// // {
							// // //console.log(response['result']['minified']);
							// // $('#txtMinifiedCss').val(decodeURIComponent(response['result']['minified']));
							// // $('.result').show();
						// // }
						// // else if(response["success"] === 'false')
						// // {
