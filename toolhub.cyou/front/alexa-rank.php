            ...
            <div class="row">
                ...
                <div class="col-md-9 col-xl-9">
                    <main>
                        ...
                        <h2 class="u-h3 u-mb-small">Check Alexa Rank</h2>
								...
								<form class="c-search-form c-search-form--dark">
									...
									<div class="c-search-form__section">
										<div class="c-field has-icon-left">
											...
											<small class="c-field__message">Enter website url to check alexa rank</small>
										</div>
									</div>

									<button class="c-btn c-btn--info" type="submit">Check Alexa Rank</button>
								</form>								
							</div>
						</div>
							...
							<div class="col-sm-12 col-lg-12 col-xl-12">
								<div class="c-state-card card" data-mh="state-cards" style="height: 143px;">
									...
									<div class="c-state-card__content">
										<p class="c-state-card__meta">Alexa Rank</p>
										<h5 class="c-state-card__number"><span class="u-text-success alexa"></span></h5>										
									</div>
								</div>
							</div><!-- // .col-md-3 -->
						</div>
			...
			$('button[type=submit]').click(function(e){
				...
				if(isValidURL($('#txtUrl').val())){
    				$.ajax({
    					...
    					type: "GET",  
    					url: "https://api.toolhub.cyou/TrackingTools.php?action=alexarank&query="+$('#txtUrl').val(),
    					success: function(serverresponse){
    						var response = serverresponse;
    						
    						if(response["success"] === 'true')
    						{
    							console.log(response['result']['alexarank']);
    							$('.alexa').html(response['result']['alexarank']);
    							$('.result').show();
    						}
