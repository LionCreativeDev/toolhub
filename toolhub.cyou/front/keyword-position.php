            ...
            <div class="row">
                ...
                <div class="col-md-9 col-xl-9">
                    <main>
                        ...
                        <h2 class="u-h3 u-mb-small">Check Keyword Position</h2>
								...
								<form class="c-search-form c-search-form--dark">
									...
									<div class="c-search-form__section">
										<div class="c-field has-icon-left">
											...
											<small class="c-field__message"></small>
										</div>
										<div class="c-field has-icon-left">
											<span class="c-field__icon"><i class="fa fa-key"></i></span>
											<label class="c-field__label c-search-form__label" for="txtUrl">Keyword</label>
											<input class="c-input" id="txtkeyword" type="text" placeholder="ie: search engine">
											<small class="c-field__message">Enter website url and keyword to check keyword position</small>
										</div>
									</div>

									<button class="c-btn c-btn--info" type="submit">Check Keyword Position</button>
								</form>								
							</div>
						</div>
						...
						<div class="row result" style="display:none;">
							<div class="col-sm-12 col-lg-12 col-xl-12">
								<div class="c-card c-card--responsive u-mb-medium card">
									<table class="c-table">
										<caption class="c-table__title">Keyword Position <small class="c-badge c-badge--success kp" style="color:white;"></small></caption></caption>
		...
		<script>
			...
			$('button[type=submit]').click(function(e){
				...
				$.ajax({
					...
					type: "GET",  
					url: "https://api.toolhub.cyou/KeywordTools.php?action=keywordposition&domain="+$('#txtUrl').val()+"&query="+$('#txtkeyword').val(), 
					success: function(serverresponse){
						...
						if(response["success"] === 'true')
						{
							...
							$('.kp').text(response['result']['position'] + ' position');
