            ...
            <div class="row">
                ...
                <div class="col-md-9 col-xl-9">
                    <main>
                        ...
                        <h2 class="u-h3 u-mb-small">Check WWW Redirect</h2>
								...
								<form class="c-search-form c-search-form--dark">
									...
									<div class="c-search-form__section">
										<div class="c-field has-icon-left">
											...
											<small class="c-field__message">Enter website url to check www redirection</small>
										</div>
									</div>

									<button class="c-btn c-btn--info" type="submit">Check Redirection</button>
								</form>								
							</div>
						</div>
						...
						<div class="row result" style="display:none;">
							<div class="col-sm-12 col-lg-12 col-xl-12">
								<div class="c-state-card card" data-mh="state-cards" style="height: 143px;">
									...
									<div class="c-state-card__content redirect">
										<p class="c-state-card__meta">Redirected to WWW </p>
<!--										<h5 class="c-state-card__number"><span class="u-text-success"></span></h5>-->
									</div>
								</div>
							</div><!-- // .col-md-3 -->
						</div>
		...
		<script>
			$('button[type=submit]').click(function(e){
				...
				$.ajax({
					...
					type: "GET",  
					url: "https://api.toolhub.cyou/TrackingTools.php?action=wwwredirect&query="+$('#txtUrl').val(),
					success: function(serverresponse){
						var response = serverresponse;
						
						if(response["success"] === 'true')
						{
							console.log(response['result']['redirected']);
							//$('.redirect').html(response['result']['redirected']);
							if(response['result']['redirected'] == "true")
								$('.redirect').append('<h5 class="c-state-card__number"><span class="u-text-success">Redirected to WWW</span></h5>');
							else
								$('.redirect').append('<h5 class="c-state-card__number"><span class="u-text-info">Not Redirected to WWW</span></h5>');
