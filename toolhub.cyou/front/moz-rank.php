            ...
            <div class="row">
                ...
                <div class="col-md-9 col-xl-9">
                    <main>
                        ...
                        <h2 class="u-h3 u-mb-small">Check Moz Rank</h2>
								...
								<form class="c-search-form c-search-form--dark">
									...
									<div class="c-search-form__section">
										<div class="c-field has-icon-left">
											...
											<small class="c-field__message">Enter website url to check moz rank</small>
										</div>
									</div>

									<button class="c-btn c-btn--info" type="submit">Check Moz Rank</button>
								</form>								
							</div>
						</div>
						...
						<div class="row result" style="display:none;">
							<div class="col-sm-12 col-lg-12 col-xl-12">
								<div class="c-card c-card--responsive u-mb-medium card">
									<table class="c-table">
										<caption class="c-table__title">Moz</caption>
										<thead class="c-table__head c-table__head--slim">
											<tr class="c-table__row">
												<th class="c-table__cell c-table__cell--head">Website Icon</th>
												<th class="c-table__cell c-table__cell--head">Domain Authority</th>
												<th class="c-table__cell c-table__cell--head">Page Authority</th>
												<th class="c-table__cell c-table__cell--head">Moz Rank</th>
										...
										<tbody>
											<tr class="c-table__row">
												...
												<td class="c-table__cell"><span class="u-block u-text-small da"></span></td>
												<td class="c-table__cell"><span class="u-block u-text-small pa"></span></td>
												<td class="c-table__cell"><span class="u-block u-text-small mr"></span></td>
											</tr>
										</tbody>
									</table>
			...
			$('button[type=submit]').click(function(e){
				...
				if(isValidURL($('#txtUrl').val())){
    				$.ajax({
    					...
    					type: "GET",  
    					url: "https://api.toolhub.cyou/TrackingTools.php?action=mozrank&query="+$('#txtUrl').val(),
    					success: function(serverresponse){
    						...
    						if(response["success"] === 'true')
    						{
    							...
    							$('.webicon').attr("src", "https://www.google.com/s2/favicons?sz=32&domain_url="+response['result']['domain']);
    							$('.da').html(response['result']['da']);
    							$('.pa').html(response['result']['pa']);
    							$('.mr').html(response['result']['mozrank']);
    							$('.result').show();
    						}
