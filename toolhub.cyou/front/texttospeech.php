            ...
            <div class="row">
                ...
                <div class="col-md-9 col-xl-9">
                    <main>
                        ...
                        <h2 class="u-h3 u-mb-small">Converter Text To Speech</h2>
								...
								<form class="c-search-form c-search-form--dark">
									...
									<div class="c-search-form__section">
										<div class="c-field has-icon-left">
											...
											<small class="c-field__message">Enter text for text to speech conversion (Max 50 Words)</small>
										</div>
									</div>

									<button class="c-btn c-btn--info" type="submit">Convert To Speech</button>
								</form>								
							</div>
						</div>
						...
						<div class="row result" style="display:none;">
							<div class="col-sm-12 col-lg-12 col-xl-12">
								<div class="c-card c-card--responsive u-mb-medium">
									<table class="c-table">
										<caption class="c-table__title">Text To Speech</caption></caption>
										<!--<thead class="c-table__head c-table__head--slim">
											<tr class="c-table__row">
												<th class="c-table__cell c-table__cell--head">Audio</th>
											</tr>
										</thead>-->
		...
		<script>
			$('button[type=submit]').click(function(e){
				...
				$.ajax({
					...
					type: "GET",  
					url: "https://api.toolhub.cyou/ContentTools.php?action=tts&query="+$('#txtText').val(), 
					success: function(serverresponse){
						var response = serverresponse;
						
						if(response["success"] === 'true')
						{
							var audio = response['result']['audio'];
							$('.result tbody').append('<tr class="c-table__row"><td class="c-table__cell"><span class="c-badge c-badge--success u-text-small">Audio</span></td><td class="c-table__cell">'+ audio +'</td></tr>');							  
							$('.result').show();
						}
