            ...
            <div class="row">
                ...
                <div class="col-md-9 col-xl-9">
                    <main>
                        ...
                        <h2 class="u-h3 u-mb-small">Get Organic Keyword</h2>
								...
								<form class="c-search-form c-search-form--dark">
									...
									<div class="c-search-form__section">
										<div class="c-field has-icon-left">
											...
											<small class="c-field__message">Enter keyword to get organic keywords</small>
										</div>
									</div>

									<button class="c-btn c-btn--info" type="submit">Get Organic Keywords</button>
								</form>								
							</div>
						</div>
						...
						<div class="row result" style="display:none;">
							<div class="col-sm-12 col-lg-12 col-xl-12">
								<div class="c-card c-card--responsive u-mb-medium card">
									<table class="c-table">
										<caption class="c-table__title">Organic Keyword <small class="tk"></small></caption></caption>
										<thead class="c-table__head c-table__head--slim">
											<tr class="c-table__row">
												<th class="c-table__cell c-table__cell--head">Keyword</th>
												<th class="c-table__cell c-table__cell--head">Search Volume</th>
											</tr>
										</thead>
		...
		<script>
			$('button[type=submit]').click(function(e){
				...
				$.ajax({
					...
					type: "GET",  
					url: "https://api.toolhub.cyou/KeywordTools.php?action=organickeywords&query="+$('#txtkeyword').val(), 
					success: function(serverresponse){
						...
						if(response["success"] === 'true')
						{
							...
							var list = response['result']['organickeywords'];
							
							list.forEach(myFunction);
							function myFunction(value) {							
								$('.result tbody').append('<tr class="c-table__row"><td class="c-table__cell"><span class="u-block u-text-small">'+value['keywordText']+'</span></td><td class="c-table__cell"><span class="c-badge c-badge--success u-text-small">'+value['searchVolume']+'</span></td></tr>');
							}
