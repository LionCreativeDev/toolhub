            ...
            <div class="row">
                ...
                <div class="col-md-9 col-xl-9">
                    <main>
                        ...
                        <h2 class="u-h3 u-mb-small">Check Compression</h2>
								...
								<form class="c-search-form c-search-form--dark">
									...
									<div class="c-search-form__section">
										<div class="c-field has-icon-left">
											...
											<small class="c-field__message">Enter website url to check compression</small>
										</div>
									</div>

									<button class="c-btn c-btn--info" type="submit">Check Compression</button>
								</form>								
							</div>
						</div>
						...
						<div class="row result" style="display:none;">
							<div class="col-sm-12 col-lg-12 col-xl-12">
								<div class="c-card c-card--responsive u-mb-medium card">
									<table class="c-table">
										<caption class="c-table__title">Compression</caption></caption>
										<thead class="c-table__head c-table__head--slim">
											<tr class="c-table__row">
												<th class="c-table__cell c-table__cell--head">Url</th>
												<th class="c-table__cell c-table__cell--head">Compression</th>
												<th class="c-table__cell c-table__cell--head">Compression Type</th>
											</tr>
										</thead>
			...
			$('button[type=submit]').click(function(e){
				...
				if(isValidURL($('#txtUrl').val())){
    				...
    				$.ajax({
    					...
    					type: "GET",  
    					url: "https://api.toolhub.cyou/WebsiteTools.php?action=checkcompression&query="+$('#txtUrl').val(), 
    					success: function(serverresponse){
    						...
    						if(response["success"] === 'true')
    						{
    							...
    							var compression = response['result']['compression'];
    							var compressiontype = response['result']['compressiontype'];
    							
    							$('.result tbody').append('<tr class="c-table__row"><td class="c-table__cell"><span class="u-block u-text-small">' + url + '</span></td><td class="c-table__cell">'+(compression == 'true' ? '<span class="c-badge c-badge--success u-text-small">' + compression + '</span>' : '<span class="c-badge c-badge--inf u-text-small">' + compression + '</span>')+'</td><td class="c-table__cell"><span class="c-badge c-badge--success u-text-small">' + compressiontype + '</span></td></tr>');
    							$('.result').show();
    						}
