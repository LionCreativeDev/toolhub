            ...
            <div class="row">
                ...
                <div class="col-md-9 col-xl-9">
                    <main>
                        ...
                        <h2 class="u-h3 u-mb-small">Check Keywords Density</h2>
								...
								<form class="c-search-form c-search-form--dark">
									...
									<div class="c-search-form__section">
										<div class="c-field has-icon-left">
											...
											<small class="c-field__message">Enter website url to check keyword density</small>
										</div>
									</div>

									<button class="c-btn c-btn--info" type="submit">Check Density</button>
								</form>								
							</div>
						</div>
						...
						<div class="row result" style="display:none;">
							<div class="col-sm-12 col-lg-12 col-xl-12">
								<div class="c-card c-card--responsive u-mb-medium card">
									<table class="c-table">
										<caption class="c-table__title">Keyword Density <small class="tk"></small></caption>
										<thead class="c-table__head c-table__head--slim">
											<tr class="c-table__row">
												<th class="c-table__cell c-table__cell--head">Keyword</th>
												<th class="c-table__cell c-table__cell--head">Count</th>
												<th class="c-table__cell c-table__cell--head">Percent</th>
											</tr>
										</thead>
			...
			$('button[type=submit]').click(function(e){
				...
				if(isValidURL($('#txtUrl').val())){
    				...
    				$.ajax({
    					...
    					type: "GET",  
    					url: "https://api.toolhub.cyou/KeywordTools.php?action=keyworddensity&query="+$('#txtUrl').val(), 
    					success: function(serverresponse){
    						...
    						if(response["success"] === 'true')
    						{
    							...
    							var list = response['result']['desity'];
    							
    							list.forEach(myFunction);
    							function myFunction(value) {
    								if(i!=0){
    									console.log(value);								
    									$('.result tbody').append('<tr class="c-table__row"><td class="c-table__cell"><span class="u-block u-text-small">'+value['keyword']+'</span></td><td class="c-table__cell"><span class="c-badge c-badge--success u-text-small">'+value['count']+'</span></td><td class="c-table__cell"><span class="c-badge c-badge--success u-text-small">'+value['percent']+'</span></td></tr>');
    								}
    								else
    								{
    									$('.tk').text(value['total words'] + ' Keywords');
    								}
    								i++;
    							}							
