            ...
            <div class="row">
                ...
                <div class="col-md-9 col-xl-9">
                    <main>
                        ...
                        <h2 class="u-h3 u-mb-small">Check Google Mobile Friendly</h2>
								...
								<form class="c-search-form c-search-form--dark">
									...
									<div class="c-search-form__section">
										<div class="c-field has-icon-left">
											...
											<small class="c-field__message">Enter website url to check Google Mobile Friendly</small>
										</div>
									</div>
							...
							<div class="col-sm-12 col-lg-12 col-xl-12">
								<div class="c-state-card card" data-mh="state-cards" style="height: 143px;">
									...
									<div class="c-state-card__content">
										<p class="c-state-card__meta">Google Mobile Friendly</p>
										<h5 class="c-state-card__number gf"></h5>
									</div>
								</div>
							</div><!-- // .col-md-3 -->
						</div>
			...
			$('button[type=submit]').click(function(e){
				...
				if(isValidURL($('#txtUrl').val())){
    				$.ajax({
    					...
    					type: "GET",  
    					url: "https://api.toolhub.cyou/WebsiteTools.php?action=mobilefriendly&query="+$('#txtUrl').val(),
    					success: function(serverresponse){
    						var response = serverresponse;
    						
    						if(response["success"] === 'true')
    						{
    							console.log(response['result']['mobile_friendly']);
    							$('.gf').html( (response['result']['mobile_friendly'] == "1") ? '<span class="u-text-success">Website is mobile friendly</span>' : '<span class="u-text-info">Website is not mobile friendly</span>');
    							$('.result').show();
    						}
