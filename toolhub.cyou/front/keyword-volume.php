            ...
            <div class="row">
                ...
                <div class="col-md-9 col-xl-9">
                    <main>
                        ...
                        <h2 class="u-h3 u-mb-small">Check Keyword Volume</h2>
								...
								<form class="c-search-form c-search-form--dark">
									...
									<div class="c-search-form__section">
										<div class="c-field has-icon-left">
											...
											<small class="c-field__message">Enter keyword to check keyword volume</small>
										</div>
									</div>

									<button class="c-btn c-btn--info" type="submit">Check Keyword Volume</button>
								</form>								
							</div>
						</div>
						...
						<div class="row result" style="display:none;">
							<div class="col-sm-12 col-lg-12 col-xl-12">
								<div class="c-card c-card--responsive u-mb-medium card">
									<table class="c-table">
										<caption class="c-table__title">Keyword Volume</caption></caption>
										<thead class="c-table__head c-table__head--slim">
											<tr class="c-table__row">
												<th class="c-table__cell c-table__cell--head">Keyword</th>
												<th class="c-table__cell c-table__cell--head">Volume</th>
												<th class="c-table__cell c-table__cell--head">CPC</th>
												<th class="c-table__cell c-table__cell--head">Competition</th>
											</tr>
										</thead>
		...
		<script>
			$('button[type=submit]').click(function(e){
				...
				$.ajax({
					...
					type: "GET",  
					url: "https://api.toolhub.cyou/KeywordTools.php?action=keywordvolume&query="+$('#txtkeyword').val(), 
					success: function(serverresponse){
						...
						if(response["success"] === 'true')
						{
							...
							$('.result tbody').append('<tr class="c-table__row"><td class="c-table__cell"><span class="u-block u-text-small">'+response['result']['keyword']+'</span></td><td class="c-table__cell"><span class="c-badge c-badge--success u-text-small">'+response['result']['volume']+'</span></td><td class="c-table__cell"><span class="c-badge c-badge--success u-text-small">'+response['result']['cpc']+'</span></td><td class="c-table__cell"><span class="c-badge c-badge--success u-text-small">'+response['result']['competition']+'</span></td></tr>');
							$('.result').show();
						}
