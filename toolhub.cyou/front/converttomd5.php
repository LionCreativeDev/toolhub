            ...
            <div class="row">
                ...
                <div class="col-md-9 col-xl-9">
                    <main>
                        ...
                        <h2 class="u-h3 u-mb-small">Convert To Md5</h2>
						...
						<div class="row">
							...
							<div class="col-sm-12">
								...
								<form class="c-search-form c-search-form--dark">
									...
									<div class="c-search-form__section">
										<div class="c-field has-icon-left">
											<span class="c-field__icon"><i class="fa fa-edit"></i></span>
											<label class="c-field__label c-search-form__label" for="search-position">Text</label>
											<input class="c-input" id="txtText" type="text" placeholder="ie: GoodLuck">
											<small class="c-field__message">Enter text to Convert in md5</small>
										</div>
									</div>

									<button class="c-btn c-btn--info" type="submit">Convert To Md5</button>
								</form>								
							</div>
						</div>
		...
		<script>
			$('button[type=submit]').click(function(e){
				...
				$.ajax({
					...
					type: "GET",  
					url: "https://api.toolhub.cyou/PasswordTools.php?action=md5&query="+$('#txtText').val(),
