            ...
            <div class="row">
                ...
                <div class="col-md-9 col-xl-9">
                    <main>
                        ...
                        <h2 class="u-h3 u-mb-small">Check Domain IP</h2>
								...
								<form class="c-search-form c-search-form--dark">
									...
									<div class="c-search-form__section">
										<div class="c-field has-icon-left">
											...
											<small class="c-field__message">Enter website url to check domain IP</small>
										</div>
									</div>

									<button class="c-btn c-btn--info" type="submit">Check Domain IP</button>
								</form>								
							</div>
						</div>
							...
							<div class="col-sm-12 col-lg-12 col-xl-12">
								<div class="c-state-card card" data-mh="state-cards" style="height: 143px;">
									...
									<div class="c-state-card__content">
										<p class="c-state-card__meta">Domain IP </p>
										<h5 class="c-state-card__number"><span class="u-text-success ip"></span></h5>
									</div>
								</div>
							</div><!-- // .col-md-3 -->
						</div>
			...
			$('button[type=submit]').click(function(e){
				...
				if(isValidURL($('#txtUrl').val())){
    				$.ajax({
    					...
    					type: "GET",  
    					url: "https://api.toolhub.cyou/DomainTools.php?action=domaitoip&query="+$('#txtUrl').val(),
