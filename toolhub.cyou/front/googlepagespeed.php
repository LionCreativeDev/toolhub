            ...
            <div class="row">
                ...
                <div class="col-md-9 col-xl-9">
                    <main>
                        ...
                        <h2 class="u-h3 u-mb-small">Check Google Pagespeed</h2>
								...
								<form class="c-search-form c-search-form--dark">
									...
									<div class="c-search-form__section">
										<div class="c-field has-icon-left">
											...
											<small class="c-field__message">Enter website to check Google Pagespeed</small>
										</div>
									</div>

									<button class="c-btn c-btn--info" type="submit">Check</button>
								</form>								
							</div>
						</div>
						...
						<div class="row result" style="display:none;">
							<div class="col-sm-12 col-lg-12 col-xl-12">
								<div class="c-card c-card--responsive u-mb-medium card">
									<table class="c-table">
										<caption class="c-table__title">Google Page Speed</caption></caption>
										<thead class="c-table__head c-table__head--slim">
											<tr class="c-table__row">
												<th class="c-table__cell c-table__cell--head">First Contentful Paint</th>
												<th class="c-table__cell c-table__cell--head">Speed Index</th>												
												<th class="c-table__cell c-table__cell--head">Interactive</th>
												<th class="c-table__cell c-table__cell--head">First Meaningful Paint</th>
												<th class="c-table__cell c-table__cell--head">First CPU Idle</th>
												<th class="c-table__cell c-table__cell--head">Estimated Input Latency</th>
											</tr>
										</thead>
			...
			$('button[type=submit]').click(function(e){
				...
				if(isValidURL($('#txtUrl').val())){
    				...
    				$.ajax({
    					...
    					type: "GET",  
    					url: "https://api.toolhub.cyou/WebsiteTools.php?action=googlepagespeed&query="+$('#txtUrl').val(), 
    					success: function(serverresponse){
    						var response = serverresponse;
    						
    						if(response["success"] === 'true')
    						{
    							//console.log(response['result']['keyword']);														
    							var FCP = response['result']['FCP'];
    							var SI = response['result']['SI'];
    							var TTI = response['result']['TTI'];
    							
    							var FMP = response['result']['FMP'];
    							var FCI = response['result']['FCI'];
    							var EIL = response['result']['EIL'];
    							
    							$('.result tbody').append('<tr class="c-table__row"><td class="c-table__cell"><span class="c-badge c-badge--success u-text-small">'+FCP+'</span></td><td class="c-table__cell"><span class="c-badge c-badge--success u-text-small">'+SI+'</span></td><td class="c-table__cell"><span class="c-badge c-badge--success u-text-small">'+TTI+'</span></td><td class="c-table__cell"><span class="c-badge c-badge--success u-text-small">'+FMP+'</span></td><td class="c-table__cell"><span class="c-badge c-badge--success u-text-small">'+FCI+'</span></td><td class="c-table__cell"><span class="c-badge c-badge--success u-text-small">'+EIL+'</span></td></tr>');
