            ...
            <div class="row">
                ...
                <div class="col-md-9 col-xl-9">
                    <main>
                        ...
                        <h2 class="u-h3 u-mb-small">Encrypt Password</h2>
								...
								<form class="c-search-form c-search-form--dark">
									...
									<div class="c-search-form__section">
										<div class="c-field has-icon-left">
											...
											<small class="c-field__message">Enter password to encrypt</small>
										</div>
									</div>

									<button class="c-btn c-btn--info" type="submit">Encrypt</button>
								</form>								
							</div>
						</div>
							...
							<div class="col-sm-12 col-lg-12 col-xl-12">
								<div class="c-state-card card" data-mh="state-cards" style="height: 143px;">
									...
									<div class="c-state-card__content">
										<p class="c-state-card__meta">des </p>
										<h5 class="c-state-card__number"><span class="u-text-success des" style="font-size: 18px;"></span></h5>										
									</div>
								</div>
							</div><!-- // .col-md-3 -->
						</div>
						...
						<div class="row result" style="display:none;">
							<div class="col-sm-12 col-lg-12 col-xl-12">
								<div class="c-state-card card" data-mh="state-cards" style="height: 143px;">
									...
									<div class="c-state-card__content">
										<p class="c-state-card__meta">md5 </p>
										<h5 class="c-state-card__number"><span class="u-text-success md5" style="font-size: 18px;"></span></h5>										
									</div>
								</div>
							</div><!-- // .col-md-3 -->
						</div>
						...
						<div class="row result" style="display:none;">
							<div class="col-sm-12 col-lg-12 col-xl-12">
								<div class="c-state-card card" data-mh="state-cards" style="height: 143px;">
									...
									<div class="c-state-card__content">
										<p class="c-state-card__meta">sha1 </p>
										<h5 class="c-state-card__number"><span class="u-text-success sha1" style="font-size: 18px;"></span></h5>										
									</div>
								</div>
							</div><!-- // .col-md-3 -->
						</div>
		...
		<script>
			$('button[type=submit]').click(function(e){
				...
				$.ajax({
					...
					type: "GET",  
					url: "https://api.toolhub.cyou/PasswordTools.php?action=encrypt&query="+$('#txtPassword').val(),
					success: function(serverresponse){
						var response = serverresponse;
						
						if(response["success"] === 'true')
						{
							console.log(response['result']['md5']);
							$('.des').html(response['result']['des']);
							$('.md5').html(response['result']['md5']);
							$('.sha1').html(response['result']['sha1']);
							$('.result').show();
						}
