            ...
            <div class="row">
                ...
                <div class="col-md-9 col-xl-9">
                    <main>
                        ...
                        <h2 class="u-h3 u-mb-small">Check IP Class of Domain</h2>
								...
								<form class="c-search-form c-search-form--dark">
									...
									<div class="c-search-form__section">
										<div class="c-field has-icon-left">
											...
											<small class="c-field__message">Enter domain to check ip class</small>
										</div>
									</div>

									<button class="c-btn c-btn--info" type="submit">Check IP Class</button>
								</form>								
							</div>
						</div>
						...
						<div class="row result" style="display:none;">
							<div class="col-sm-12 col-lg-12 col-xl-12">
								<div class="c-card c-card--responsive u-mb-medium card">
									<table class="c-table">
										<caption class="c-table__title">IP Class</caption>
										<thead class="c-table__head c-table__head--slim">
											<tr class="c-table__row">
												<th class="c-table__cell c-table__cell--head">Website Icon</th>
												<th class="c-table__cell c-table__cell--head">Domain</th>
												<th class="c-table__cell c-table__cell--head">IP</th>
												<th class="c-table__cell c-table__cell--head">IP Class</th>
											</tr>
										</thead>
										...
										<tbody>
											<tr class="c-table__row">
												...
												<td class="c-table__cell"><span class="u-block u-text-small domain"></span></td>
												<td class="c-table__cell"><span class="u-block u-text-small ip"></span></td>
												<td class="c-table__cell"><span class="u-text-small c-badge c-badge--success ipclass"></span></td>
											</tr>
										</tbody>
									</table>
			...
			$('button[type=submit]').click(function(e){
				...
				if(isValidURL($('#txtUrl').val())){
    				$.ajax({
    					...
    					type: "GET",  
    					url: "https://api.toolhub.cyou/TrackingTools.php?action=detectipclass&query="+$('#txtUrl').val(),
    					success: function(serverresponse){
    						...
    						if(response["success"] === 'true')
    						{
    							...
    							$('.domain').html(response['result']['domain']);
    							$('.ip').html(response['result']['ip']);
    							$('.ipclass').html(response['result']['class']);
    							$('.result').show();
    						}
