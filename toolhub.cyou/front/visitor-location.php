            ...
            <div class="row">
                ...
                <div class="col-md-9 col-xl-9">
                    <main>
                        ...
                        <h2 class="u-h3 u-mb-small">Check Visitor's Location</h2>
						...
						<div class="row">
							...
							<div class="col-sm-12">
								...
								<form class="c-search-form c-search-form--dark">
									...
									<button class="c-btn c-btn--info" type="submit">Check Visitor's Location</button>
								</form>								
							</div>
						</div>
							...
							<div class="col-sm-12 col-lg-12 col-xl-12">
								<div class="c-state-card card" data-mh="state-cards" style="height: 143px;">
									...
									<div class="c-state-card__content">
										<p class="c-state-card__meta">Visitor's Location is </p>
										<h5 class="c-state-card__number"><span class="u-text-success lbllocation">Karachi</span></h5>										
									</div>
								</div>
							</div><!-- // .col-md-3 -->
						</div>
		...
		<script>
			$('button[type=submit]').click(function(e){
				...
				$.ajax({
					...
					type: "GET",  
					url: "https://api.toolhub.cyou/IPTools.php?action=visitorlocation",
