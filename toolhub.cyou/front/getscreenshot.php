            ...
            <div class="row">
                ...
                <div class="col-md-9 col-xl-9">
                    <main>
                        ...
                        <h2 class="u-h3 u-mb-small">Get Website Screenshot</h2>
								...
								<form class="c-search-form c-search-form--dark">
									...
									<div class="c-search-form__section">
										<div class="c-field has-icon-left">
											...
											<small class="c-field__message">Enter website url to get secreenshot</small>
										</div>
									</div>

									<button class="c-btn c-btn--info" type="submit">Get Screenshot</button>
								</form>								
							</div>
						</div>
						...
						<div class="row result" style="display:none;">
							<div class="col-sm-12 col-lg-12 col-xl-12">
								<div class="c-search-form c-search-form--dark">
									...
									<div class="c-search-form__section">
										<div class="c-field has-icon-left">
											<label class="c-field__label c-search-form__label" for="search-position">Screenshot</label>
											<img alt="screenshot" src="" class="screenshot">
										</div>
									</div>
			...
			$('button[type=submit]').click(function(e){
				...
				if(isValidURL($('#txtUrl').val())){
    				...
    				$.ajax({
    					...
    					type: "GET",  
    					url: "https://api.toolhub.cyou/WebsiteTools.php?action=screenshot&query="+$('#txtUrl').val(), 
    					success: function(serverresponse){
    						...
    						if(response["success"] === 'true')
    						{
    							...
    							var result = response['result']['png'];
    							
    							$('.screenshot').attr('src',result);
    							$('.result').show();
    						}
