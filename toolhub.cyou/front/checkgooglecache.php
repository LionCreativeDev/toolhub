            ...
            <div class="row">
                ...
                <div class="col-md-9 col-xl-9">
                    <main>
                        ...
                        <h2 class="u-h3 u-mb-small">Check Website Cache On Google</h2>
								...
								<form class="c-search-form c-search-form--dark">
									...
									<div class="c-search-form__section">
										<div class="c-field has-icon-left">
											...
											<small class="c-field__message">Enter website url to check google cache</small>
										</div>
									</div>
							...
							<div class="col-sm-12 col-lg-12 col-xl-12">
								<div class="c-state-card card" data-mh="state-cards" style="height: 143px;">
									...
									<div class="c-state-card__content">
										<p class="c-state-card__meta">Google Cache</p>
										<h5 class="c-state-card__number gc"></h5>										
									</div>
								</div>
							</div><!-- // .col-md-3 -->
						</div>
			...
			$('button[type=submit]').click(function(e){
				...
				if(isValidURL($('#txtUrl').val())){
    				$.ajax({
    					...
    					type: "GET",  
    					url: "https://api.toolhub.cyou/TrackingTools.php?action=checkgooglecache&query="+$("#txtUrl").val(),
    					success: function(serverresponse){
    						...
    						{
    							//console.log(response['result']['googlecache']);
    							$('.gc').append((response['result']['googlecache'] == "true") ? '<span class="u-text-success">Is In Google Cache</span>' : '<span class="u-text-info">Not In Google Cache</span>');
    							$('.result').show();
    						}
