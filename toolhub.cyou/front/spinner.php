            ...
            <div class="row">
                ...
                <div class="col-md-9 col-xl-9">
                    <main>
                        ...
                        <h2 class="u-h3 u-mb-small">Article Spinner</h2>
								...
								<form class="c-search-form c-search-form--dark">
									...
									<div class="c-search-form__section">
										<div class="c-field has-icon-left">
											...
											<small class="c-field__message">Enter article to spin</small>
										</div>
									</div>

									<button class="c-btn c-btn--info" type="submit">Spin Article</button>
								</form>								
							</div>
						</div>
							...
							<div class="col-sm-12 col-lg-12 col-xl-12">
								<div class="c-search-form c-search-form--dark">
									...
									<div class="c-search-form__section">
										<div class="c-field has-icon-left">
											<!--<span class="c-field__icon"><i class="fa fa-user-o"></i></span>-->
											<label class="c-field__label c-search-form__label" for="search-position">Spinned Article</label>
											<textarea class="c-input" id="txtResultantArticle"></textarea>
		...
		<script>
			$('button[type=submit]').click(function(e){
				...
				$.ajax({
					...
					type: "GET",  
					url: "https://api.toolhub.cyou/ContentTools.php?action=spin&query="+$('#txtArticle').val(),
					success: function(serverresponse){
						var response = serverresponse;
						
						if(response["success"] === 'true')
						{
							console.log(response['result']['spinned']);
							$('#txtResultantArticle').val(response['result']['spinned']);
							$('.result').show();
						}
