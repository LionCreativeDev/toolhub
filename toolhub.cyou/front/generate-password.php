            ...
            <div class="row">
                ...
                <div class="col-md-9 col-xl-9">
                    <main>
                        ...
                        <h2 class="u-h3 u-mb-small">Generate Password</h2>
								...
								<form class="c-search-form c-search-form--dark">
									...
									<div class="c-search-form__section">
										<div class="c-field has-icon-left">
											...
											<label class="c-field__label c-search-form__label" for="txtLength">Length</label>
											<input class="c-input" id="txtLength" type="number" placeholder="ie: 8" value="8" min="8" max="16">
											<small class="c-field__message">Enter password length between 8 and 16</small>
										</div>
									</div>

									<button class="c-btn c-btn--info" type="submit">Generate Password</button>
								</form>								
							</div>
						</div>
							...
							<div class="col-sm-12 col-lg-12 col-xl-12">
								<div class="c-state-card card" data-mh="state-cards" style="height: 143px;">
									...
									<div class="c-state-card__content">
										<p class="c-state-card__meta">Generated Password </p>
										<h5 class="c-state-card__number"><span class="u-text-success gp"></span></h5>										
									</div>
								</div>
							</div><!-- // .col-md-3 -->
						</div>
		...
		<script>
			$('button[type=submit]').click(function(e){
				...
				$.ajax({
					...
					type: "GET",  
					url: "https://api.toolhub.cyou/PasswordTools.php?action=password&query="+$('#txtLength').val(),
					success: function(serverresponse){
						...
						if(response["success"] === 'true')
						{
							...
							$('.gp').html(response['result']['password']);
							$('.result').show();
						}
