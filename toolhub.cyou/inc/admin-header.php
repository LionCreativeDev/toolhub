...
echo '<div class="se-pre-con"></div>
        <header class="c-navbar u-mb-medium card">
		<a class="c-navbar__brand" href="https://toolhub.cyou">
			<img src="../template/img/logo.png" alt="Dashboard\'s Logo">
		</a>
		...
		<!--<nav class="c-nav collapse" id="main-nav">
			<ul class="c-nav__list">
				<li class="c-nav__item">
					<a class="c-nav__link" href="index.php">Home</a>
				</li>
				<li class="c-nav__item">
					<a class="c-nav__link" href="aboutus.php">About Us</a>
				</li>
				<li class="c-nav__item">
					<a class="c-nav__link" href="contactus.php">Contact Us</a>
				</li>
			</ul>
		</nav>-->
		<!-- // Navigation items  -->
